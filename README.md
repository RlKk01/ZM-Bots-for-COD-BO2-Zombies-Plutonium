...
* Bots can be commanded using the "follow", "stay" or "wander" commands, by double-tap the "2" key on the keyboard or, if using a controller, by double-tapping the down arrow on the directional pad.
