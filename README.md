...
* A pickup «Power Up» function with a smart check to avoid to pick up nukes if there are no zombies left (but they may bump on accident to the powerup on specific conditions).
